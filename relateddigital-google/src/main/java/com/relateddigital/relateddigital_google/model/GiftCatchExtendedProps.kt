...
class GiftCatchExtendedProps : Serializable{
    ...
    @SerializedName("mail_subscription_form"            ) var mailSubscriptionForm           : GiftRainExtendedPropsMailSubsForm? = null
    @SerializedName("gamification_rules"                ) var gamificationRules              : GiftRainExtendedPropsGamificationRules?    = null
    @SerializedName("game_elements"                     ) var gameElements                   : GiftRainExtendedPropsGameElements?         = null
    @SerializedName("game_result_elements"              ) var gameResultElements             : GiftRainExtendedPropsGameResultElements?   = null
