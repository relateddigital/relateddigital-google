...
class FindToWinExtendedProps : Serializable {
    ...
    var mailSubscriptionForm: FindToWinExtendedPropsMailSubscriptionForm? = null

    @SerializedName("gamification_rules")
    var gamificationRules: FindToWinExtendedPropsGamificationRules? = null

    @SerializedName("game_elements")
    var gameElements: FindToWinExtendedPropsGameElements? = null

    @SerializedName("game_result_elements")
    var gameResultElements: FindToWinExtendedPropsGameResultElements? = null
