...
class ChooseFavoriteExtendedProps : Serializable {
    ...
    @SerializedName("mail_subscription_form"            ) var mailSubscriptionForm           : ChooseFavoriteExtendedPropsMailSubscriptionForm? = null
    @SerializedName("gamification_rules"                ) var gamificationRules              : ChooseFavoriteExtendedPropsGamificationRules?    = null
    @SerializedName("game_elements"                     ) var gameElements                   : ChooseFavoriteExtendedPropsGameElements?         = null
    @SerializedName("game_result_elements"              ) var gameResultElements             : ChooseFavoriteExtendedPropsGameResultElements?   = null
