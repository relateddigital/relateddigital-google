...
class JackpotExtendedProps : Serializable{
    ...
    @SerializedName("mail_subscription_form"            ) var mailSubscriptionForm           : JackpotExtendedPropsMailSubscriptionForm? = JackpotExtendedPropsMailSubscriptionForm()
    @SerializedName("gamification_rules"                ) var gamificationRules              : JackpotExtendedPropsGamificationRules?    = JackpotExtendedPropsGamificationRules()
    @SerializedName("game_elements"                     ) var gameElements                   : JackpotExtendedPropsGameElements?         = JackpotExtendedPropsGameElements()
    @SerializedName("game_result_elements"              ) var gameResultElements             : JackpotExtendedPropsGameResultElements?   = JackpotExtendedPropsGameResultElements()
