        ...
        call.enqueue(object : Callback<ResponseBody?> {
            override fun onResponse(
                ...
                if (responseJs.isSuccessful) {
                    Log.i(LOG_TAG, "Getting chooseFavorite.js is successful!")
                    chooseFavoriteJsStr = responseJs.body()!!.string()

                    if(chooseFavoriteJsStr.isEmpty()) {
                        Log.e(LOG_TAG, "Getting chooseFavorite.js failed!")
                        finish()
                    } else {
                        if (savedInstanceState != null) {
                            ...
                            if (intent != null && intent.hasExtra("choose-favorite-data")) {
                                ...
                                if (response != null) {
                                    ...
                                    Log.e(LOG_TAG, "Could not get the chooseFavorite data properly!")
                                    finish()
                                }
                            } else {
                                Log.e(LOG_TAG, "Could not get the chooseFavorite data properly!")
                        ...
                        if (jsonStr != null && jsonStr != "") {
                            ...
                            if(res == null) {
                                ...
                                val webViewDialogFragment: ChooseFavoriteWebDialogFragment =
                                    ChooseFavoriteWebDialogFragment.newInstance(
                                        res[0],
                                        res[1],
                                        res[2]
                                    )
            ...
            override fun onFailure(call: Call<ResponseBody?>, t: Throwable) {
                Log.e(LOG_TAG, "Getting chooseFavorite.js failed! - ${t.message}")
                finish()
            }
        })
    }
